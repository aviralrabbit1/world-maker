...
export default function Home() {
  return (
    <>
      <section className="h-full w-full pt-36 relative flex flex-col 
      items-center justify-center">
          ...
          <div className="flex justify-center items-center relative md:mt-[-70px]">
            <Image src={'/assets/preview.png'} alt="image" height={1200} width={1200}
            className="rounded-tl-2xl rounded-tr-2xl border-2 border-muted" /> 
            <div className="bottom-0 top-[50%] bg-gradient-to-t dark:from-bavkground left-0 right-0 absolute z-10 ">
